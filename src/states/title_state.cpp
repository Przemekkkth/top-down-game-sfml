    ...
    m_showText(false), m_textEffectTime(sf::Time::Zero)
{
    ...
    getContext().textures->get(Textures::SFML_LOGO).setSmooth(true);
    m_sfmlLogo.setOrigin( m_sfmlLogo.getGlobalBounds().width/2.0f, m_sfmlLogo.getGlobalBounds().height/2.0f);
    m_sfmlLogo.setPosition(Application::HALF_WIDTH, 75);
    ...
    m_text0.setPosition(Application::HALF_WIDTH, 170);
    ...
    m_avatarLogo.setPosition(Application::HALF_WIDTH, 350);
    ...
    m_text1.setPosition(Application::HALF_WIDTH, 500);
}
